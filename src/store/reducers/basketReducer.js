import { ADD_GOODS, CHANGE_GOODS_COUNT, REMOVE_GOODS, REMOVE_GOODS_ALL } from "../../constants";
  ...
  switch (action.type) {
    ...
    case REMOVE_GOODS:
      return {
        ...
        totalCost: (state.totalCost - Number(action.payload.price * action.payload.counter)),
      };
